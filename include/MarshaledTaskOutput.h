...
void unmarshal1() {
    ...
    {
	MarshaledMyString var(msh_cursor, 'u');
...
void marshal12() {
    ...
    //Now just copy "get" functions here
    {
	memcpy(msh_cursor, &Shadowed_param->inDirSize, sizeof(int));
    }
    //Now advance the cursor
    msh_cursor += msh_currentSize;
    //Now set the size of this field
...
void unmarshal12() {
    ...
    //Now copy the setspec here
    {
	memcpy(&Shadowed_param->inDirSize, msh_cursor, sizeof(int));
...
void marshal13() {
    ...
    //Now just copy "get" functions here
    {
	memcpy(msh_cursor, &Shadowed_param->outDirSize, sizeof(int));
    }
    //Now advance the cursor
    msh_cursor += msh_currentSize;
    //Now set the size of this field
...
void unmarshal13() {
    ...
    //Now copy the setspec here
    {
	memcpy(&Shadowed_param->outDirSize, msh_cursor, sizeof(int));
...
void marshal14() {
    ...
    //Now just copy "get" functions here
    {
	memcpy(msh_cursor, &Shadowed_param->fileSize, sizeof(int));
    }
    //Now advance the cursor
    msh_cursor += msh_currentSize;
    //Now set the size of this field
...
void unmarshal14() {
    ...
    //Now copy the setspec here
    {
	memcpy(&Shadowed_param->fileSize, msh_cursor, sizeof(int));
...
void marshal17() {
    ...
    //Now just copy "get" functions here
    {
	memcpy(msh_cursor, &Shadowed_param->duration, sizeof(double));
    }
    //Now advance the cursor
    msh_cursor += msh_currentSize;
    //Now set the size of this field
...
void unmarshal17() {
    ...
    //Now copy the setspec here
    {
	memcpy(&Shadowed_param->duration, msh_cursor, sizeof(double));
...
void marshal18() {
    ...
    //Now just copy "get" functions here
    {
	memcpy(msh_cursor, &Shadowed_param->success, sizeof(bool));
    }
    //Now advance the cursor
    msh_cursor += msh_currentSize;
    //Now set the size of this field
...
void unmarshal18() {
    ...
    //Now copy the setspec here
    {
	memcpy(&Shadowed_param->success, msh_cursor, sizeof(bool));
